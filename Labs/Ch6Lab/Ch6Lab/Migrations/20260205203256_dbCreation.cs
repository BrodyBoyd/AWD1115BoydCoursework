    ...
    public partial class dbCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ASP.NET Core is a free open-source web framework.", "gen", "What is ASP.NET Core?", "asp" },
                    { 2, "ASP.NET Core 1.0 was released on June 27, 2016.", "hist", "When was ASP.NET Core released?", "asp" },
                    { 3, "Blazor is a free and open-source web framework.", "gen", "What is Blazor?", "blz" },
                    { 4, "Blazor was released on May 14, 2020.", "hist", "When was Blazor released?", "blz" },
                    { 5, "Entity Framework is an open-source ORM for .NET applications supported by Microsoft.", "gen", "What is Entity Framework?", "ef" },
