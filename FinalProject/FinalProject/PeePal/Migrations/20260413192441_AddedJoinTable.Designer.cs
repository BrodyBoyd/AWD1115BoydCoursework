...
namespace PeePal.Migrations
{
    ...
    [Migration("20260413192441_AddedJoinTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserBathroom", b =>
                {
                    b.Property<string>("FavoritedById")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("FavoritesBathroomId")
                        .HasColumnType("int");

                    b.HasKey("FavoritedById", "FavoritesBathroomId");

                    b.HasIndex("FavoritesBathroomId");

                    b.ToTable("ApplicationUserBathroom");
                });
            ...
            modelBuilder.Entity("ApplicationUserBathroom", b =>
                {
                    ...
                    b.HasOne("PeePal.Models.Bathroom", null)
                        .WithMany()
                        .HasForeignKey("FavoritesBathroomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
