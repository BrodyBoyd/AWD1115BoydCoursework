...
namespace HOT5.Migrations
{
    ...
    [Migration("20260310210549_changedDataType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HOT5.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HOT5.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("HOT5.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("HOT5.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("HOT5.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HOT5.Models.Order", b =>
                {
                    b.HasOne("HOT5.Models.ApplicationUser", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("HOT5.Models.OrderItem", b =>
                {
                    b.HasOne("HOT5.Models.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HOT5.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("HOT5.Models.Product", b =>
                {
                    b.HasOne("HOT5.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HOT5.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
